...
void SoftmaxWeightedLossLayer<Dtype>::LayerSetUp(
...
template <typename Dtype>
SoftmaxWeightedLossLayer<Dtype>::~SoftmaxWeightedLossLayer() {
...
template <typename Dtype>
void SoftmaxWeightedLossLayer<Dtype>::Reshape(
    const vector<Blob<Dtype>*>& bottom, const vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
Dtype SoftmaxWeightedLossLayer<Dtype>::get_normalizer(
...
template <typename Dtype>
void SoftmaxWeightedLossLayer<Dtype>::Forward_cpu(
    const vector<Blob<Dtype>*>& bottom, const vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
void SoftmaxWeightedLossLayer<Dtype>::Backward_cpu(const vector<Blob<Dtype>*>& top,
...
#ifdef CPU_ONLY
STUB_GPU(SoftmaxWeightedLossLayer);
#endif

INSTANTIATE_CLASS(SoftmaxWeightedLossLayer);
REGISTER_LAYER_CLASS(SoftmaxWeightedLoss);
