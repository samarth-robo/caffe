 ...
 * input to a EuclideanWeightedLossLayer exactly formulates a linear least squares
...
class EuclideanWeightedLossLayer : public LossLayer<Dtype> {
 public:
  ...
  /**
   * Unlike most loss layers, in the EuclideanWeightedLossLayer we can backpropagate
 ...
 protected:
   ...
   *
   * Unlike other children of LossLayer, EuclideanWeightedLossLayer \b can compute
